...
loessMod80 <- loess(uempmed ~ index, data=economics, span=0.80) # 80% smoothing span
loessMod90 <- loess(uempmed ~ index, data=economics, span=0.90) # 90% smoothing span
loessMod97 <- loess(uempmed ~ index, data=economics, span=0.97) # 97% smoothing span
...
lines(smoothed80, x=economics$date, col="orange") 
lines(smoothed90, x=economics$date, col="pink") 
lines(smoothed97, x=economics$date, col="purple") 
